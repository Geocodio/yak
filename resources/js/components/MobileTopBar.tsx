 ...
 * left, search on the right; new task and navigation live in the floating
 * tab bar. The top padding keeps it clear of the status bar when Yak runs
 * from the home screen with a translucent status bar and `viewport-fit=cover`.
 */
