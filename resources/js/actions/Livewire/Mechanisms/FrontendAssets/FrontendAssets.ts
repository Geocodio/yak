...
* @route '/livewire-069fdc81/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-069fdc81/livewire.js',
...
* @route '/livewire-069fdc81/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-069fdc81/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-069fdc81/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-069fdc81/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
