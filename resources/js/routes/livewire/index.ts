...
* @route '/livewire-069fdc81/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-069fdc81/upload-file',
...
* @route '/livewire-069fdc81/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-069fdc81/preview-file/{filename}',
