...
6. VISUAL CAPTURE: When the task involves UI changes and a dev URL is available, take screenshots after your changes to verify visual correctness. IMPORTANT: Always stop any dev servers (npm, gatsby, vite, etc.) you started before finishing your work. Background processes prevent the task from completing.
