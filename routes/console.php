...
Schedule::command('yak:telemetry:prune')->daily();
Schedule::command('yak:telemetry:sample-queues')->everyMinute();
Schedule::command('yak:reconcile-pr-state')->hourly()->withoutOverlapping();
