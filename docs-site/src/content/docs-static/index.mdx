...
template: splash
hero:
  tagline: Yak is an autonomous coding agent for papercuts. It picks up small tasks from Slack, Linear, Sentry, and GitHub and delivers reviewable pull requests while you work on what matters.
  image:
...
<CardGrid>
  ...
  <Card title="Fixes papercuts" icon="approve-check">
    ...
    the fix is small and focused, and the description is under a paragraph.
  </Card>
